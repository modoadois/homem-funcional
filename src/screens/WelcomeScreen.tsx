...
const WelcomeScreen: React.FC = () => {
  ...
  const handleConnect = async () => {
    try {
      // openSelectKey triggers the Google account/project selection dialog
    ...
    <Layout className="bg-background-dark text-white">
      <main className="flex-1 flex flex-col items-center justify-center px-8 text-center space-y-10">
        ...
        <div className="space-y-3">
          ...
          <p className="text-slate-400 text-sm font-medium leading-relaxed max-w-[280px] mx-auto">
            O Google exige um "projeto" para liberar a IA, mas o uso do Gemini 3 neste app é gratuito.
          </p>
        </div>

        {/* Guia de Ajuda para o Dialog do Google */}
        <div className="w-full bg-white/5 border border-white/10 rounded-3xl p-6 text-left space-y-4">
          <p className="text-[10px] font-black uppercase tracking-widest text-primary/80">O que você verá a seguir:</p>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <p className="text-[11px] text-slate-300">
                O Google pedirá para você escolher um <strong>"Projeto Pago"</strong> (nome técnico para o plano com API).
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <p className="text-[11px] text-slate-300">
                Selecione seu projeto. Mesmo com esse nome, o uso do <strong>Gemini 3 Flash</strong> tem uma cota gratuita generosa.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <p className="text-[11px] text-slate-300">
                O app será ativado e você poderá disparar sua produtividade.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full space-y-6">
          ...
          >
            Ver detalhes da cota gratuita oficial
      ...
      <footer className="p-8 text-center">
        <p className="text-[9px] text-white/20 font-medium uppercase tracking-[0.3em]">
          Ambiente Seguro via Google AI Studio
        </p>
      </footer>
    </Layout>
  );
